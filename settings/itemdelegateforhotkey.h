...
class ItemDelegateForHotkey : public QStyledItemDelegate
{
  ...
  public:
    ...
    QWidget * createEditor(QWidget * a_pParent, const QStyleOptionViewItem & a_option,
        const QModelIndex & a_index) const override;

    void setEditorData(QWidget * a_pEditor, const QModelIndex & a_index) const override;

    void updateEditorGeometry(QWidget * a_pEditor, const QStyleOptionViewItem & a_option,
        const QModelIndex & a_index) const override;
