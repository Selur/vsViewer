  ...
  , m_pSaveAction(nullptr)
{
  ...
  connect(m_ui.snippetNameComboBox, SIGNAL(activated(const QString &)), this, SLOT(slotSnippetNameComboBoxActivated(const QString &)));
#else
  connect(m_ui.snippetNameComboBox, SIGNAL(textActivated(const QString &)), this, SLOT(slotSnippetNameComboBoxActivated(const QString &)));
#endif
