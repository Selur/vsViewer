...
typedef int (VS_CC *FNP_vssEvaluateScript)(VSScript ** a_handle, const char * a_script,
...
class VapourSynthScriptProcessor : public QObject
{
  ...
  public:
    ...
    VapourSynthScriptProcessor(SettingsManager * a_pSettingsManager, QObject * a_pParent = nullptr);
    ...
    void colorAtPoint(size_t a_x, size_t a_y, double & a_rValue1, double & a_rValue2,
        double & a_rValue3);
