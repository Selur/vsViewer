...
class VapourSynthPluginsManager : public QObject
{
  ...
  public:
    ...
    explicit VapourSynthPluginsManager(SettingsManager * a_pSettingsManager, QObject * a_pParent = nullptr);
    ...
    friend void VS_CC fakeConfigPlugin(const char * a_identifier, const char * a_defaultNamespace,
        const char * a_name, int a_apiVersion, int a_readonly, VSPlugin * a_pPlugin);
    friend void VS_CC fakeRegisterFunction(const char * a_name, const char * a_args,
